...
export const HoverComponent = ({translate, top, left} : {translate: {x: number, y: number}, top: number, left: number}) => {
  return (
    <>
        ...
        <div className={`translate-x-[-${translate.x}%] translate-y-[-${translate.y}%] absolute z-40 top-[${top}%] left-[${left}%] flex items-center gap-4`}>
