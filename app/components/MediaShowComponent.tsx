...
export const MediaShowComponent = ({media, overview, reviews, credits}: {media: any, overview: string, reviews: any, credits: any}) => {
  return (
    <div className="flex max-w-360 relative gap-6 justify-between">
        ...
        <div className="absolute w-1/2 right-4 top-[50%] bg-blue-rgba-950 p-6 rounded-2xl">
            ...
            {credits && (
              <TeamListComponent team={credits.cast.length ? credits.cast : credits.crew} />
            )}
